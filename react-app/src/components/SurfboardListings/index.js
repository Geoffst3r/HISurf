...
const Listings = () => {
    ...
    //     const val = document.getElementById('size-select').value;
    //     if (!val) return;
    //     else listings = listings.filter(listing => listing.size === parseInt(val));
    //     return
    // };
    ...
    //     if (!listings) return;
    //     listings = Object.values(listingsObj);
    //     const val = document.getElementById('island-select').value;
    //     if (!val) return;
    //     else listings = listings.filter(listing => listing.location === val);
    //     return
    // };
